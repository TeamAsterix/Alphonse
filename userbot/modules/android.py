""" Userbot module containing commands related to android"""
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern="magisk$"))
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)")))
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern="pixeldl(?: |$)(.*)"))
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
 ...
 CMD_HELP.update(
     {
         "android": f"**Plugins : **`android`\
         \n\n • **Syntax :** `{cmd}magisk`\
         \n • **Function : **Get the latest Magisk release \
         ...
         \n • **Function : **Download pixel experience ROM to your user bot server.  \
         \n\n • **Syntax :** `{cmd}specs <brand> <device>`\
         \n • **Function : **Get device specification info.  \
