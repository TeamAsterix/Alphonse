import asyncio
 ...
 @bot.on(alphonse_cmd(pattern=r"download(?: |$)(.*)", outgoing=True))
 ...
 @bot.on(alphonse_cmd(pattern=r"upload (.*)", outgoing=True))
 ...
 CMD_HELP.update(
     {
         ...
         \n\n • **Syntax :** `{cmd}download` <link|filename> or reply to media\
         \n • **Function : **To download files to the server.\
         \n\n • **Syntax :** `{cmd}upload`\
         \n • **Function : **Upload locally saved file to chat.\
     "
     }
 )