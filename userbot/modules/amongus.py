from io import BytesIO
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"imp (.*)"))
 ...
 async def bruh(message, user):
     ...
     name = "***" + name
     await message.edit(name + choice([" ", " No "]) + "Is a Fraud! ***")
 ...
 CMD_HELP.update(
     {
         ...
         \n\n • **Syntax :** `{cmd}imp`\
         \n • **Function : **Send a picture of an Among US impostor with your own words.\
     "
     }
 )