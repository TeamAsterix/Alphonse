# Authored by @Khrisna_Singhal
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"(mirror|flip|ghost|bw|poster)$"))
 async def transform(event):
     if not event.reply_to_msg_id:
         await event.edit("**Please Reply to Media or Sticker**")
         return
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"rotate(?: |$)(.*)")))
 ...
 CMD_HELP.update(
     {
         ...
         \n\n • **Syntax :** `{cmd}flip`\
         \n • **Function : **To reverse your image.\
         \n\n • **Syntax :** `{cmd}mirror`\
         \n • **Function : **To mirror your image.\
         \n\n • **Syntax :** `{cmd}bw`\
         \n • **Function : **To convert your color image to b / w image.\
         \n\n • **Syntax :** `{cmd}poster`\
         \n • **Function : **To poster your image.\
         \n\n • **Syntax :** `{cmd}rotate` <value>\
         \n • **Function : **To poster your image.\
         \n\n • **Syntax :** `{cmd}poster`\
         \n • **Function : **To rotate your image **The value ranges from 1-360 otherwise it will give a default value of 90**\
     "
     }
 )