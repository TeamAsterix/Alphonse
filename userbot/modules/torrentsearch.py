import codecs
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"ts (.*)"))
 async def complete(e):
 ...
 @bot.on(alphonse_cmd(outgoing=True, pattern=r"tos(?: |$)(.*)"))
 ...
 CMD_HELP.update(
     {
         ...
         \n • **Function : **Find torrent query and post to dogbin.\
         \n\n • **Syntax :** `{cmd}tos` <search query>\
         \n • **Function : **Search for torrent magnet from query.\
     "
     }
 )