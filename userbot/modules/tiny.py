# Ultroid - UserBot
 ...
 from userbot.utils import bash, alphonse_cmd


 @alphonse_cmd(pattern="tiny(?: |$)(.*)")
 async def ultiny(event):
     ...
     im1 = Image.open("userbot/resources/alphonse_blank.png")
     if ik.endswith(.tgs"):
 ...
 CMD_HELP.update(
     {
         "tiny": f"**Plugin : **`tiny`\
         \n\n • **Syntax :** `{cmd}tiny` <reply to media>\
         \n • **Function : **To Change Sticker To Small.\
     "
     }
 )