...
def alphonse_cmd(pattern=None, command=None, **args):
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**✘ ALPHONSE ERROR REPORT ✘**\n\n"
                    link = "[Group Support](https://t.me/AlphonseSupport)"
                   text += "If you wish, you can report this error,"
                    ...
                    ftext += "\nJust forward this message to @AlphonseSupport"
                    ftext += "\n================================\n\n"
