...
from alphonsebot import BLACKLIST, BOT_VERSION, BRAIN, TEMP_SETTINGS, app, get_translation

from .misc import _parsed_prefix, edit, get_cmd, is_admin
from .alphonselog import send_log_doc


def alphonseify(**args):
