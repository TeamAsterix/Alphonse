...
from alphonseecem.core import edit, extract_args, get_translation, alphonseify, use_proxy


@alphonseify(pattern='^.magisk$')
def magisk(message):
    magisk_dict = {
...
@alphonseify(pattern=r'^.codename')
...
@alphonseify(pattern=r'^.o(range|)f(ox|rp)')
def ofox(message):
