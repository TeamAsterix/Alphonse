...
from alphonsebot import GENIUS_TOKEN, HELP
from alphonseecem.core import edit, extract_args, get_translation, reply_doc, alphonseify


@alphonseify(pattern='^.lyrics')
def lyrics(message):
