...
from alphonsebot import BRAIN, HELP, LOGS, TEMP_SETTINGS
...
def globals_init():
    try:
        ...
        sql = import_module('alphonseecem.sql.gban_sql')
        sql2 = import_module('alphonseecem.sql.gmute_sql')
...
@alphonseify(pattern='^.gban', compat=False)
...
@alphonseify(pattern='^.(ung|gun)ban', compat=False)
...
@alphonseify(pattern='^.gmute', compat=False)
...
@alphonseify(pattern='^.ungmute', compat=False)
