...
from alphonsebot import HELP, PACKNAME, PACKNICK, TEMP_SETTINGS
...
@alphonseify(pattern='^.(kang)', compat=False)
...
@alphonseify(pattern='^.getsticker')
...
@alphonseify(pattern='.packinfo$', compat=False)
