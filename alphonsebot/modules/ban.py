...
from alphonsebot import BRAIN, HELP
...
@alphonseify(pattern='^.ban', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.unban', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.kick', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.mute', compat=False, private=False, admin=True)
def mute_user(client, message):
    try:
        from alphonseecem.sql import mute_sql as sql
    except BaseException:
...
@alphonseify(pattern='^.unmute', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.promote', admin=True, private=False, compat=False)
...
@alphonseify(pattern='^.demote', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.pin$', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.unpin', compat=False, private=False, admin=True)
...
@alphonseify(pattern='^.(admins|bots|user(s|sdel))$', compat=False, private=False)
...
@alphonseify(pattern='^.zombies', private=False, compat=False)
...
@alphonseify(pattern='^.setgpic$', compat=False, admin=True, private=False)
...
@alphonseify(incoming=True, outgoing=False, compat=False)
