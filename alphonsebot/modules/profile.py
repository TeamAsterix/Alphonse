...
from alphonsebot import HELP, TEMP_SETTINGS
...
@alphonseify(pattern='^.reserved$', compat=False)
...
@alphonseify(pattern='^.name', compat=False)
...
@alphonseify(pattern='^.setpfp$', compat=False)
...
@alphonseify(pattern='^.delpfp', compat=False)
...
@alphonseify(pattern='^.setbio', compat=False)
...
@alphonseify(pattern='^.username', compat=False)
...
@alphonseify(pattern='^.block$', compat=False)
...
@alphonseify(pattern='^.unblock$', compat=False)
...
@alphonseify(pattern='^.online', compat=False)
...
@alphonseify(pattern='^.stats$', compat=False)
